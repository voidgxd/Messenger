...
//  Messenger
//
//  Created by Максим Мосалёв on 12.06.2023.
//
...
extension LoginViewController {
    private func setupConstraints() {
        ...
        let bottomStackView = UIStackView(arrangedSubviews: [needAnAccountLabel, signInButton], axis: .horizontal, spacing: 0)
        ...
        NSLayoutConstraint.activate([stackView.topAnchor.constraint(equalTo: welcomeLabel.bottomAnchor, constant: 70),
